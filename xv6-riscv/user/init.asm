...
main(void)
{
  ...
  6e:	89e50513          	addi	a0,a0,-1890 # 908 <malloc+0x152>
  ...
  b2:	81250513          	addi	a0,a0,-2030 # 8c0 <malloc+0x10a>
  b6:	00000097          	auipc	ra,0x0
  ba:	642080e7          	jalr	1602(ra) # 6f8 <printf>
      printf("init: fork failed\n");
  be:	00001517          	auipc	a0,0x1
  c2:	81250513          	addi	a0,a0,-2030 # 8d0 <malloc+0x11a>
  c6:	00000097          	auipc	ra,0x0
  ca:	632080e7          	jalr	1586(ra) # 6f8 <printf>
      exit(1);
  ce:	4505                	li	a0,1
  d0:	00000097          	auipc	ra,0x0
  d4:	2b0080e7          	jalr	688(ra) # 380 <exit>
      exec("sh", argv);
  d8:	00001597          	auipc	a1,0x1
  dc:	87058593          	addi	a1,a1,-1936 # 948 <argv>
  e0:	00001517          	auipc	a0,0x1
  e4:	80850513          	addi	a0,a0,-2040 # 8e8 <malloc+0x132>
  e8:	00000097          	auipc	ra,0x0
  ec:	2d0080e7          	jalr	720(ra) # 3b8 <exec>
      printf("init: exec sh failed\n");
  f0:	00001517          	auipc	a0,0x1
  f4:	80050513          	addi	a0,a0,-2048 # 8f0 <malloc+0x13a>
  f8:	00000097          	auipc	ra,0x0
  fc:	600080e7          	jalr	1536(ra) # 6f8 <printf>
      exit(1);
 100:	4505                	li	a0,1
 102:	00000097          	auipc	ra,0x0
 106:	27e080e7          	jalr	638(ra) # 380 <exit>
...
memset(void *dst, int c, uint n)
{
 ...
 180:	0800                	addi	s0,sp,16
  ...
  int i;
  for(i = 0; i < n; i++){
 182:	ce09                	beqz	a2,19c <memset+0x20>
 184:	87aa                	mv	a5,a0
 186:	fff6071b          	addiw	a4,a2,-1
 18a:	1702                	slli	a4,a4,0x20
 18c:	9301                	srli	a4,a4,0x20
 18e:	0705                	addi	a4,a4,1
 190:	972a                	add	a4,a4,a0
    cdst[i] = c;
 192:	00b78023          	sb	a1,0(a5)
  for(i = 0; i < n; i++){
 196:	0785                	addi	a5,a5,1
 198:	fee79de3          	bne	a5,a4,192 <memset+0x16>
  }
  return dst;
}
 19c:	6422                	ld	s0,8(sp)
...
gets(char *buf, int max)
{
 ...
 1fc:	1a0080e7          	jalr	416(ra) # 398 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 24e:	176080e7          	jalr	374(ra) # 3c0 <open>
  if(fd < 0)
 ...
 25e:	17e080e7          	jalr	382(ra) # 3d8 <fstat>
 262:	892a                	mv	s2,a0
  close(fd);
 264:	8526                	mv	a0,s1
 266:	00000097          	auipc	ra,0x0
 26a:	142080e7          	jalr	322(ra) # 3a8 <close>
  return r;
}
 26e:	854a                	mv	a0,s2
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 2ce:	0800                	addi	s0,sp,16
  ...
  src = vsrc;
  if (src > dst) {
 2d0:	02b57663          	bgeu	a0,a1,2fc <memmove+0x32>
    while(n-- > 0)
 2d4:	02c05163          	blez	a2,2f6 <memmove+0x2c>
 ...
 2ee:	fed70fa3          	sb	a3,-1(a4)
    while(n-- > 0)
 2f2:	fee79ae3          	bne	a5,a4,2e6 <memmove+0x1c>
    src += n;
    while(n-- > 0)
      *--dst = *--src;
  }
 ...
 300:	95b2                	add	a1,a1,a2
    while(n-- > 0)
 302:	fec05ae3          	blez	a2,2f6 <memmove+0x2c>
 ...
 31c:	00d70023          	sb	a3,0(a4)
    while(n-- > 0)
 320:	fee79ae3          	bne	a5,a4,314 <memmove+0x4a>
 324:	bfc9                	j	2f6 <memmove+0x2c>
...
memcpy(void *dst, const void *src, uint n)
{
 ...
 36c:	f62080e7          	jalr	-158(ra) # 2ca <memmove>
}
 370:	60a2                	ld	ra,8(sp)
 372:	6402                	ld	s0,0(sp)
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 534:	400b8b93          	addi	s7,s7,1024 # 930 <digits>
 ...
 674:	2b890913          	addi	s2,s2,696 # 928 <malloc+0x172>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7de:	17e53503          	ld	a0,382(a0) # 958 <freep>
 ...
 806:	15690913          	addi	s2,s2,342 # 958 <freep>
  if(p == (char*)-1)
 80a:	5afd                	li	s5,-1
 80c:	a88d                	j	87e <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 80e:	00000797          	auipc	a5,0x0
 812:	15278793          	addi	a5,a5,338 # 960 <base>
 ...
 840:	10a73e23          	sd	a0,284(a4) # 958 <freep>
      return (void*)(p + 1);
